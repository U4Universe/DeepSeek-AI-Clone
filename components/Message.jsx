                            ...
                            <div className="flex items-center gap-2 opacity-70">
                                {role === 'user' ? (
                                    ...
                                    <>
                                        ...
                                        <Image src={assets.regenerate_icon_icon} alt="" className="w-4 cursor-pointer" />
                                        <Image src={assets.like_icon_icon} alt="" className="w-4 cursor-pointer" />
                                        <Image src={assets.dislike_icon_icon} alt="" className="w-4 cursor-pointer" />
                                    </>
                                )}
                            </div>
                        </div>
